...
import MoreDetailsList from "./moreDetails";
import "./itembox.css";
...
class ItemBox extends Component {
  ...
  /**
   * Book Coloring Functions and colors
   */
  primary_book_color = [
    "#4089ff",
    "#74D3AE",
  ...
  render() {
        ...
        >
          ...
          <div className="right-side-of-book">
            <div className="heading-of-item-box">
              <h1 className="item-name indent-text">
                {ParticularCard.itemName}
              </h1>
            </div>
            <div className="item-more-information indent-text">
              <div className="item-price-in-box">
                <Link>{ParticularCard.itemPrice} {this.state.itemPriceUnit}</Link>
              </div>

              {/**
               * Here wer enter the more details list is a form of array of strings
               * ["More Detail 1","More Detail 2",...."More Detail n"]
               */}
              <MoreDetailsList moreDetails={ParticularCard.moreDetails} />

              {/**
               * Here is the BUY NOW Butto
               */}
            ...
            <div className="item-more-information indent-text">
              <h4 className="item-box-label">
                From:{" "}
                <Link className="item-owner-id">
                  {ParticularCard.itemOwner}
                </Link>
              </h4>
            </div>
          </div>
    ...
    if (AllCardDetails.length) {
      return <div className="row g-4 set-height-in-items-container">{CardList}</div>;
    } else {
      return (<div className="no-items-in-the-list">No books could be found <br />*Sad Reader Noises* <br /> Try adding Some</div>);
    }
  }
  /**
   * End
      ...
      <div className="col-lg-6vcol-sm-12 col-12 whole-item-container-div">
        ...
        <div className="right-side-of-book">
          ...
          <div className="item-more-information indent-text">
             ...
             * ["More Detail 1","More Detail 2",...."More Detail n"]
             */}
            <MoreDetailsList moreDetails={this.state.moreDetails} />
