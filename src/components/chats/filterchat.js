...
class Filterchat extends Component {
  state = {
    heading: " ",
    content: " ",
    receiver: " ",
        ...
        <div className="col-12 the-blog-containing-div" >
          ...
          <div className="blog-content-div">
            ...
            <span className="blog-blogger-name">
                -From :   <Link style={{color:"white"}}>{ParticularCard.writer}</Link>
              </span>
            </p>
            <p style={{textAlign:"right"}}>
            <span className="blog-blogger-name">
                -Receiver :   <Link style={{color:"white"}}>{ParticularCard.receiver}</Link>
              </span>
            </p>
          </div>
        </div>
