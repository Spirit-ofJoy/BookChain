...
import "./logo_animations.css";

const MetamaskLogo = () => {
  return (
    <div className="metamask-logo-metamask-about-page">
      {/*       <img
        scr="./assets/metamask.svg"
        className="metamask-logo-on-metamask-about-page"
        alt="This is the metamask svg logo"
      /> */}
      <svg
      className="metamask-logo-on-metamask-about-page"
        id="Layer_1"
